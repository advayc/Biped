...
int main()
{
  ...
  while(1)
  {
    for(right_hip = 80; right_hip <= 130; right_hip++)
    {
      convert();
    }
    _delay_ms(100);
    for(right_hip = 130; right_hip >= 80; right_hip--)
    {
      convert();
    }
    _delay_ms(100);
    ...
    {
    for(left_hip = 130; left_hip <= 80; left_hip++)
    {
      convert();
    }
    _delay_ms(100);
    for(left_hip = 80; left_hip >= 130; left_hip--)
    {
      convert();
    }
    _delay_ms(100);
...
void convert()
  {
    ...
    count_angle1 = right_foot + 40;
    count_angle2 = left_hip + 46;
    count_angle3 = left_foot + 86;
